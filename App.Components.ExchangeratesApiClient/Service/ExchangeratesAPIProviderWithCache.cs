...
namespace App.Components.ExchangeratesApiClient
{
    public class ExchangeratesAPIProviderWithCache : ExchangeratesAPIProvider
    {
        ...
        private readonly ILogger<ExchangeratesAPIProviderWithCache> _logger;
       
        public ExchangeratesAPIProviderWithCache(IOptions<ExchangeratesApiOptions> options, IHttpClientFactory httpClientFactory,IMemoryCache memoryCache, ILogger<ExchangeratesAPIProviderWithCache> logger) : base(options, httpClientFactory)
        {
